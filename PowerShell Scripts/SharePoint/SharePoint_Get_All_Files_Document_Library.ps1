...
$ListName= "Departmental Files"
$ReportOutput = "C:\Temp\Artis_Department_Files_Legal_Documents.csv"
$Pagesize = 500
...
#Read more: https://www.sharepointdiary.com/2018/08/sharepoint-online-powershell-to-get-all-files-in-document-library.html#ixzz7aueXzNuL